...
const ourservices = [
    ...
    // Business Support
    { category: 'Business Support', link: 'Foundation & Compliance', topic: 'Foundation & Compliance', text: 'Expert handling of CAC registration and filing, full regulatory compliance (SCUML, TCC, and related bodies), plus basic business setup delivered with complete transparency and zero hidden fees. AI-assisted verification tools accelerate every process, minimize errors effectively, and provide real-time status updates throughout.', image: 'happy-expert-checking-documents.jpg' },
    { category: 'Business Support', link: 'Growth & Visibility Tools', topic: 'Growth & Visibility Tools', text: 'Professional development of winning proposals, in-depth market or competitor research, polished company and individual profiles/portfolios, ATS-optimized CV/resume crafting, plus strategic social media and email marketing campaigns. AI enhancements deliver intelligent drafting, keyword optimization, audience insights, automated scheduling, and analytics for maximum engagement.', image: 'happy-successful-business-leader-signing-agreement.jpg' },
    { category: 'Business Support', link: 'AI Advanced Strategy & Scaling', topic: 'AI Advanced Strategy & Scaling', text: 'End-to-end support for high-stakes opportunities including sophisticated proposal customization with data-driven narratives, advanced research synthesis, premium branding via enhanced profiles/portfolios/CVs, and integrated digital marketing (social + email) with full-funnel management. Leveraging AI-powered predictive analytics, sentiment analysis, personalization, and automation to forecast trends and deliver measurable ROI.', image: 'business-objects-with-executives-discussing-blueprint-meeting.jpg' },
