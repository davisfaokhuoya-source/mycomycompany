const teamData = [ // Renamed the constant to avoid conflict
    ...
    {image:'Untitled.png', sec : 0.4,  name: 'Habeeb Bright', socialMeida1:'', socialMeida2:'', socialMeida3:'', socialMeida4:'', profession: 'Tech Bro'},
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        teamData.forEach(element => {
            htmlcode += `<div class ="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="${element.sec}">
                         <div class="team-item">
                            <div class="team-img">
                                <img src="img/${element.image}" class="img-fluid "  style="height: 205px; width: 205px;" alt="">
                            </div>
